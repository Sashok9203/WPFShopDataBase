...
namespace WPFShopDataBase.Data
{
    public static class Data
    {
        ...
        public static readonly Product[] Products =
        {
            ...
            new(){ /*Id=28,*/Name="Lipstick",Price=371,Discount=3,CategoryId=7,Quantity=79 ,IsLnStock = true },
            new(){ /*Id=29,*/Name="Mascara",Price=847,Discount=2,CategoryId=7,Quantity=32 ,IsLnStock = true },
            new(){ /*Id=30,*/Name="Powder",Price=188,Discount=8,CategoryId=7,Quantity=57,IsLnStock = false },

            new(){ /*Id=28,*/Name="Toothpaste",Price=371,Discount=3,CategoryId=8,Quantity=79 ,IsLnStock = true },
            new(){ /*Id=29,*/Name="Soap",Price=847,Discount=2,CategoryId=8,Quantity=32 ,IsLnStock = true },
            new(){ /*Id=30,*/Name="Shampoos",Price=188,Discount=8,CategoryId=8,Quantity=57,IsLnStock = false },
        };
